...
const LandingPage = () => {
  return (
    <div>
      ...
      {/* New Section */}
      <div className="bg-gray-200 mt-20 rounded-lg p-8 font-poppins text-black">
        <h2 className="text-2xl font-bold mb-10">Step into the heart of Bowles Farming</h2>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <img src="https://img.freepik.com/free-photo/traditional-japanese-food-court_23-2148759581.jpg?t=st=1713042668~exp=1713046268~hmac=82ed91238a6dbad7dabe75d7699558b7d96d22a8fbe63811c3a4b51a1e50c341&w=740" alt="Image" className="rounded-lg" />
          <img src="https://img.freepik.com/premium-photo/farmers-red-fresh-tomatoes-market-red-tomatoes-background_862994-14580.jpg?w=740" alt="Image" className="rounded-lg" />
          <img src="https://img.freepik.com/free-photo/woman-with-summer-hat-groceries-smiles_23-2148648924.jpg?t=st=1713042554~exp=1713046154~hmac=2784443ac75f23b60c75aeb6ff70ec67118f7699de8049898046728595d894e1&w=740" alt="Image" className="rounded-lg" />
          <img src="https://img.freepik.com/free-photo/female-baker-holding-baked-fresh-macaroons-pastries-tray_23-2148028064.jpg?t=st=1713042766~exp=1713046366~hmac=666d92aa83a4c5889a93959f6e429186f40550b30f723ee0d3f40bfd8e1829c7&w=740" alt="Image" className="rounded-lg" />
          <img src="https://img.freepik.com/free-photo/man-painting-home_23-2148017381.jpg?t=st=1713042826~exp=1713046426~hmac=7993c5d6312f9a4973080f8cf9fc6de62d4df69d36f3862446568970ed9d25dc&w=740" alt="Image" className="rounded-lg" />
          <img src="https://img.freepik.com/premium-photo/man-buying-fruits-vegetables-farmers-market_894855-2304.jpg?w=740" alt="Image" className="rounded-lg" />
        </div>
      </div>
    </div>
  );
